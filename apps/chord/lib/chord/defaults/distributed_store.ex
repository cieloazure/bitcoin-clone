defmodule Chord.Defaults.DistributedStore do
  @moduledoc """
  Defaults.DistributedStore
  ...
  @doc """
  Defaults.DistributedStore.start_link
  ...
  @doc """
  Defaults.DistributedStore.write
  ...
  @doc """
  Defaults.DistributedStore.read
  ...
  @doc """
  Defaults.DistributedStore.delete
  ...
  @doc """
  Defaults.DistributedStore.query
  ...
  @doc """
  Defaults.DistributedStore.init
  ...
  * items
  ...
  @doc """
  Defaults.DistributedStore callback for `:write`
  ...
  @doc """
  Defaults.DistributedStore callback for `:read`
  ...
  @doc """
  Defaults.DistributedStore callback for `:delete`
  ...
  @doc """
  Defaults.DistributedStore callback for `:query`
